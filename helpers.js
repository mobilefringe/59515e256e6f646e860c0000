...
function getShopStores (all_categories) {
   // var all_categories = getStoreCategories();
    ...
    var shop_stores = [];
    $.each( all_categories , function( i, cat ) {
        if((cat.name.indexOf("Apparel") > -1) || (cat.name.indexOf("Accessories")> -1) || (cat.name.indexOf("Jewellery")> -1)|| (cat.name.indexOf("'s Wear")> -1)|| (cat.name.indexOf("Toys")> -1)|| (cat.name.indexOf("Athletic")> -1)|| (cat.name.indexOf("Stationary")> -1)|| (cat.name.indexOf("Beauty Product")> -1) || (cat.name.indexOf("Stationary")> -1) || (cat.name.indexOf("Stationary")> -1)){
            //console.log(cat);
